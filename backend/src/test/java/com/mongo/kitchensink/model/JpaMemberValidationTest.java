...
/**
 * Unit tests for the JpaMember model validation constraints.
 * These tests verify that the validation annotations work as expected.
 */
public class JpaMemberValidationTest {

    private Validator validator;
    private JpaMember validMember;
    ...
    void validMember_NoViolations() {
        // Act
        Set<ConstraintViolation<JpaMember>> violations = validator.validate(validMember);
    ...
    void multipleInvalidFields_HasMultipleViolations() {
        // Arrange
        JpaMember invalidMember = JpaMember.builder()
                .name("")
                .email("invalid-email")
        ...
        // Act
        Set<ConstraintViolation<JpaMember>> violations = validator.validate(invalidMember);
